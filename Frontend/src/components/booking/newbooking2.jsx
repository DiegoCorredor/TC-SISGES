                ...
                <div className='flex align-items-center justify-content-center my-8'>
                    <div className='align-items-center justify-content-center'>
                        <div className='gray-color py-8 px-5 sm:px-8 rounded'>
                            <h4 className='text-900 text-3xl font-medium text-center'>Algo ha salido mal</h4><hr />
                            <p className="text-600 font-medium text-center">Su reservación ha fallado, la transacción<br/>
                                fue rechazada, vuelva a intentarlo por favor.</p>
                            <div className='card'>
